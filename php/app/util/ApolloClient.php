...
class ApolloClient
{
    protected $configServer; //apollo服务端地址,监听8080端口的哪个域名
    protected $appId; //apollo配置项目的appid
    protected $cluster = 'default'; //聚群名
    ...
    public function pullConfigBatch(array $namespaceNames) {
        ...
        foreach ($request_list as $namespaceName => $req) {
            ...
            if ($code == 200) {
                ...
                //写配置文件
                if($this->is_debug) {
                    echo 'save file: ' . $req['config_file'] . PHP_EOL;
                }
    ...
    protected function _listenChange(&$ch, $callback = null) {
        ...
        do {
            ...
            if($this->is_debug) {
                echo "长连接地址：" . $base_url.$query . PHP_EOL .PHP_EOL;
            }
